                        ...
                        <div id="image-preview-container" class="d-flex flex-wrap">
                            ...
                            @if($blog->image)
                                <div class="position-relative">
                                    <img src="{{env('ASSET2_URL'). $blog->image}}" class="img-thumbnail" style="width: 150px; margin: 5px;">
                                    <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0 m-1 remove-image" data-image-id="primary"><i class="bx bx-x"></i></button>
                                </div>
                            @endif
                            ...
                            @foreach($blog->images as $image)
                                <div class="position-relative">
                                    <img src="{{env('ASSET2_URL'). $image->image_path}}" class="img-thumbnail" style="width: 150px; margin: 5px;">
                                    <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0 m-1 remove-image" data-image-id="{{ $image->id }}"><i class="bx bx-x"></i></button>
                                </div>
                            @endforeach
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="blog-title" name="title" class="form-control" value="{{ $blog->title }}" placeholder="Blog Title">
                                </div>
                            </div>
                            <div class="col-lg-6">
