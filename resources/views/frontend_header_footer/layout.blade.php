                                    ...
                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="#">Pages</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li><a href="shop.html"><img src="{{ asset('frontend_assets/img/banner/menu-banner-1.jpg')}}" alt="#"></a>
                                                </li>
                                            </ul>
                                        </li>
   ...
   <div id="ltn__utilize-cart-menu" class="ltn__utilize ltn__utilize-cart-menu">
            ...
            <div class="mini-cart-product-area ltn__scrollbar">
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="frontend_assets/img/product/1.png" alt="Image"></a>
                ...
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="frontend_assets/img/product/2.png" alt="Image"></a>
                        <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                    </div>
                    <div class="mini-cart-info">
                ...
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="frontend_assets/img/product/3.png" alt="Image"></a>
                        <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                    </div>
                    <div class="mini-cart-info">
                ...
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="frontend_assets/img/product/4.png" alt="Image"></a>
                        <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                    </div>
                    <div class="mini-cart-info">
    ...
    <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">
                    <a href="index.html"><img src="frontend_assets/img/logo.png" alt="Logo"></a>
                </div>
                <button class="ltn__utilize-close">×</button>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            <div class="footer-logo">
                                <div class="site-logo">
                                    <img src="{{ asset('frontend_assets/img/logo-2.png')}}" alt="Logo">
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                        <div class="footer-widget footer-newsletter-widget">
                            ...
                            <img src="{{ asset('frontend_assets/img/icons/payment-4.png')}}" alt="Payment Image">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Body main wrapper end -->
    ...
    <script src="{{ URL::asset('custom/ajaxPost.js')}}"></script>
    <script src="{{ URL::asset('custom/status-update.js')}}"></script>
    <script src="{{ URL::asset('custom/form-upload.js')}}"></script>
    <script src="{{ URL::asset('custom/image-preview.js')}}"></script>
    <script src="{{ URL::asset('custom/pagination.js')}}"></script>
    <script src="{{ URL::asset('custom/filemanager.js')}}"></script>
