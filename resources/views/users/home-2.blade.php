			...
			<section class="section-hero hero-2 position-relative overflow-hidden max-width">
					...
					<div class="row g-0">
						...
						<div class="col-md-6">
							<div class="hero-image-responsive">							
								<picture>						
									<source media="(max-width:500px)" srcset="assets/images/hero-8-sm.jpg">
									<source media="(max-width:767px)" srcset="assets/images/hero-8-md.jpg">				
									<source media="(max-width:1400px)" srcset="assets/images/hero-8-xxl.jpg">				
									<img src="assets/images/hero-8.jpg" alt="hero-img">
								</picture>
							</div>
						</div>
					</div>
				...
				<div class="row g-0">
					<div class="col-sm-6 col-lg-4">
						<div class="overlay">
							<img src="assets/images/hero-5.jpg" class="img-fluid w-100" alt="img">
							<h5 class="hero-hightlighted-text hero-heading-color fw-extra-bold">Space Alchemy</h5>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4">
						<div class="overlay">
							<img src="assets/images/hero-6.jpg" class="img-fluid w-100" alt="img">
							<h5 class="hero-hightlighted-text hero-heading-color fw-extra-bold">Design Symphony</h5>
						</div>
					</div>
					<div class="col-sm-6 col-lg-4">
						<div class="position-relative">
							<img src="assets/images/hero-7.jpg" class="img-fluid w-100" alt="img">
						...
						<div class="swiper blog-swiper">
							<div class="swiper-wrapper"> 
								<div class="swiper-slide">
									<div class="blog-wrapper">
										<div class="blog-image">
											<img src="assets/images/blog-image-1.jpg" class="img-fluid" alt="img">
										</div>
								...
								<div class="swiper-slide">
									<div class="blog-wrapper">
										<div class="blog-image">
											<img src="assets/images/blog-image-2.jpg" class="img-fluid" alt="img">
										</div>
										<div class="blog-details">
								...
								<div class="swiper-slide">
									<div class="blog-wrapper">
										<div class="blog-image">
											<img src="assets/images/blog-image-3.jpg" class="img-fluid" alt="img">
										</div>
										<div class="blog-details">
