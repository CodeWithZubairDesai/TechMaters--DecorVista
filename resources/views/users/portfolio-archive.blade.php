                        ...
                        <div class="project-overview-details bg-primary text-secondary wow slideInLeft">
                            <div>
                                ...
                                <div class="mt-4 mt-lg-30 mt-xxl-40">
									...
									<button onclick="BookAppointment('{{ route('users.appointments.store', $portfolio['id']) }}')" class="btn btn-primary d-inline-flex align-items-center gap-10">
    Book Appointment
</button>
                        ...
                        <div class="project-overview-details bg-primary text-secondary position-relative wow slideInRight">
                            <div>
                                ...
                                <div class="mt-4 mt-lg-30 mt-xxl-40">
                                    ...
                                    <!-- Book Appointment Button -->
                                    <a href="{{ route('users.appointments.store', $portfolio['id']) }}" class="btn btn-primary d-inline-flex align-items-center gap-10">Book Appointment</a>
                                </div>
                            </div>
                        </div>
                    </div>
