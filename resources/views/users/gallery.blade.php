    ...
    <div class="row" id="portfolio-items">
        ...
        @foreach ($galleries as $items)
            @foreach ($items as $gallery)
                <div class="col-md-3 col-sm-6 portfolio-item category-{{ $gallery->category_id }}">
                    <!-- Use the provided image path with ASSET2_URL -->
                    <img src="{{ env('ASSET2_URL') . $gallery->name }}" alt="Gallery Image">
                </div>
            @endforeach
        @endforeach
    </div>
