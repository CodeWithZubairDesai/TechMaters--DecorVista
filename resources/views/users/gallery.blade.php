...
<body>
            ...
            <div class="container-fluid max-width">
                <div class="d-flex align-items-end">
                    <a class="navbar-brand py-0" href="index.html">
                        <span class="logo">
                            {{-- <img src="{{ asset('logo/Tech_Master_Decor_Vista.jpg') }}" height="100px" width="100px" alt="logo"> --}}
                            <img src="{{ asset('logo/logoo.jpg') }}" height="100px" width="100px" alt="logo">
                            <svg width="219" height="31" viewBox="0 0 219 31" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M196.212 30.2799L203.852 19.3199L196.172 8.43994H203.132L208.892 16.9199H205.852L211.612 8.43994H218.572L210.892 19.3199L218.492 30.2799H211.572L205.932 21.7999H208.812L203.172 30.2799H196.212Z" />
                                <path
                                    d="M187.541 30.28V8.43998H193.541V30.28H187.541ZM187.541 6.47998V0.47998H193.541V6.47998H187.541Z" />
                                <path
                                ...
                                <path
                                    d="M94.885 30.28V8.43998H100.885V30.28H94.885ZM94.885 6.47998V0.47998H100.885V6.47998H94.885Z" />
                                <path
                                ...
                                <path
                                    d="M0 30.28L10.08 0.47998H18.32L28.4 30.28H21.64L19.64 24.2H8.72L6.72 30.28H0ZM10.44 18.8H17.92L13.36 4.71998H15.04L10.44 18.8Z" />
                            </svg>
                        </span>
                    </a>
          ...
          <svg width="10" height="9" viewBox="0 0 10 9" fill="none" xmlns="http://www.w3.org/2000/svg">
           <path d="M0.396 0.673999L2.484 0.673999L5.238 7.028L4.5 7.028L7.272 0.673999L9.36 0.673999L5.85 8.648L3.906 8.648L0.396 0.673999Z"/>
                        ...
                        <ul class="dropdown-menu dropdown-menu-style-2">
                            <li>
                                <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                        src="admin_admin_assets/assets/admin_assets/assets/images/flag-us.png')}}"
                                        alt="flag-us">
                            ...
                            <li>
                                <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                        src="admin_admin_assets/assets/admin_assets/assets/images/flag-de.png')}}"
                                        alt="flag-de">
                            ...
                            <li>
                                <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                        src="admin_admin_assets/assets/admin_assets/assets/images/flag-fr.png')}}"
                                        alt="flag-fr">
                            ...
                            <li>
                                <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                        src="{{ asset('user_assets/assets/images/flag-ar.png') }}" alt="flag-ar">
                ...
                <a href="javascript:void(0)" class="toggler-icon text-decoration-none d-block d-xl-none"
                    data-bs-toggle="offcanvas" data-bs-target="#architronixNavbar" aria-controls="architronixNavbar"
                    aria-label="Toggle navigation">
                    <svg width="40" height="23" viewBox="0 0 40 23" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <line x1="1.5" y1="1.5" x2="38.5" y2="1.5" stroke="#253B2F"
                            stroke-width="3" stroke-linecap="round" />
                        <line x1="1.5" y1="11.5" x2="38.5" y2="11.5" stroke="#253B2F"
                            stroke-width="3" stroke-linecap="round" />
                        <line x1="21.5" y1="21.5" x2="38.5" y2="21.5" stroke="#253B2F"
                            stroke-width="3" stroke-linecap="round" />
                    </svg>
                </a>
                <div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="architronixNavbar"
                    aria-labelledby="architronixNavbarLabel">
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 align-items-xl-center">
                                            ...
                                            <div class="row g-0">
                                                    ...
                                                    <div class="d-flex gap-30 flex-column py-40 ps-30 pe-40">
                                                        ...
                                                        <div class="menu-description">
                                                            <a href="service-single.html"
                                                                ...
                                                                Planning</a>
                                                            <p class="small mb-0 pt-10">Maximize the potential of your
                                                                space</p>
                                                        </div>
                                                        <!-- menu-description -->
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-description">
                                                            <a href="service-single.html"
                                                                ...
                                                                Consultation</a>
                                                            <p class="small mb-0 pt-10">We help you choose the perfect
                                                                palette</p>
                                                        </div>
                                                        <!-- menu-description -->
                                                        <div class="menu-description">
                                                            <a href="service-single.html"
                                                                ...
                                                                Management</a>
                                                            <p class="small mb-0 pt-10">We oversee every detail for a
                                                        ...
                                                        <div class="menu-description">
                                                            <a href="service-single.html"
                                                                ...
                                                                Furnishings</a>
                                                            <p class="small mb-0 pt-10">Elevate your space with unique
                                                                furnishings</p>
                                                        </div>
                                                        <!-- menu-description -->
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    <div
                                                        ...
                                                        <div class="menu-description">
                                                            <a href="service-single.html"
                                                                class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Concept
                                                                Development</a>
                                                        ...
                                                        <div class="menu-description">
                                                            <a href="service-single.html"
                                                                class="menu-heading text-decoration-none link-hover-animation-1 pb-1">Revamps
                                                                & Remodels</a>
                                                            <p class="small mb-0 pt-10">Renovation and remodeling
                                                                services that breathe new life</p>
                                                        </div>
                                                        <!-- menu-description -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="menu-image-wrapper position-relative h-100">
                                                        <img src="{{ asset('user_assets/assets/images/menu-image-1.png') }}"
                                                            class="w-100 h-100" alt="img">
                                                        <div class="menu-image-contents px-3">
                                                            <h4 class="mb-90 px-0 px-xl-10 fw-extra-bold">Embark on a
                                                                Design Journey with Us</h4>
                                                            <div class="architronix-button">
                                                                <a href="contact-2.html"
                                                                    class="btn btn-secondary d-inline-flex gap-10 w-100"
                                                                    target="_blank">Lets Talk
                                                                    <svg width="35" height="22"
                                                                        viewBox="0 0 35 22" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex flex-column">
                                                <a class="dropdown-item" href="about-us.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">About Us</span></a>
                                                <a class="dropdown-item" href="services.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Services</span></a>
                                                <a class="dropdown-item" href="service-single.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Service Single</span></a>
                                                <a class="dropdown-item" href="project-single.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Project Single</span></a>
                                                <a class="dropdown-item" href="product-single.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Product Single</span></a>
                                                <a class="dropdown-item" href="product-archive.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Product Archive</span></a>
                                                <a class="dropdown-item" href="checkout.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Checkout Page</span></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="d-flex flex-column dropdown-items-separator separator">
                                                <a class="dropdown-item" href="cart.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Cart Page</span></a>
                                                <a class="dropdown-item" href="career.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Career</span></a>
                                                <a class="dropdown-item" href="job-details.html"
                                                    aria-label="single-pages"><span class="link-hover-animation-1">Job
                                                        Details</span></a>
                                                <a class="dropdown-item" href="team.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Team</span></a>
                                                <a class="dropdown-item" href="team-single.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Team Single</span></a>
                                                <a class="dropdown-item" href="contact.html"
                                                    aria-label="single-pages"><span
                                                        class="link-hover-animation-1">Contact</span></a>
                                                <a class="dropdown-item" href="404-page.html"
                                                    aria-label="single-pages"><span class="link-hover-animation-1">404
                                                        Page</span></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="nav-item">
                                <div class="d-flex gap-4 align-items-center">
                                    <a class="nav-link nav-link-icon" href="#" data-bs-toggle="modal"
                                    ...
                                    <a class="nav-link nav-link-icon d-block d-xl-none" href="#"
                                        data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                                        aria-controls="offcanvasCart" aria-expanded="false"
                                        aria-label="Toggle navigation">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item d-none d-xl-block">
                                <a class="nav-link nav-link-icon" href="#" data-bs-toggle="offcanvas"
                            ...
                            <li class="nav-item dropdown text-uppercase fw-semibold d-none d-xl-block">
                                <a href="#" class="nav-link nav-link-icon d-flex align-items-center gap-1"
                                    aria-label="nav-links" data-bs-toggle="dropdown" aria-expanded="false">
                                    en
                                    <span class="dropdown-icon">
                                        <svg width="12" height="9" viewBox="0 0 12 9" fill="none"
                                ...
                                <ul class="dropdown-menu dropdown-menu-style-2">
                                    <li>
                                        <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                                src="{{ asset('user_assets/assets/images/flag-us.png') }}"
                                                alt="flag-us">
                                            <span class="text-uppercase">en</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                                src="{{ asset('user_assets/assets/images/flag-de.png') }}"
                                                alt="flag-de">
                                            <span class="text-uppercase">de</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                                src="{{ asset('user_assets/assets/images/flag-fr.png') }}"
                                                alt="flag-fr">
                                            <span class="text-uppercase">fr</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="dropdown-item d-flex gap-1 align-items-center"><img
                                                src="{{ asset('user_assets/assets/images/flag-ar.png') }}"
                                                alt="flag-ar">
                                            <span class="text-uppercase">ar</span>
                                        </a>
                                    </li>
                ...
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <svg width="55" height="55" viewBox="0 0 55 55" fill="none"
                            ...
                            <line x1="1.93543" y1="53.4393" x2="52.9354" y2="2.43934" stroke="#D2E0D9"
                                stroke-width="3" />
                        </svg>
                    </button>
                </div>
    ...
    <footer class="section-footer section-full-width bg-secondary position-relative">
        <div class="container">
                ...
                <div class="row gy-5 gy-lg-0 align-items-center justify-content-between">
                    <div class="col-lg-4">
                        <div>
                            ...
                            <ul class="contact-lists list-unstyled mb-0 d-flex">
                                <li><a href="#"
                                        class="link-hover-animation-1 text-decoration-none text-uppercase"
                                        aria-label="top-bar-link">fb</a></li>
                                <li><a href="#"
                                        class="link-hover-animation-1 text-decoration-none text-uppercase"
                                        aria-label="top-bar-link">in</a></li>
                                <li><a href="#"
                                        class="link-hover-animation-1 text-decoration-none text-uppercase"
                                        aria-label="top-bar-link">tw</a></li>
                                <li><a href="#"
                                        class="link-hover-animation-1 text-decoration-none text-uppercase"
                                        aria-label="top-bar-link">li</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- col-4 -->
                    <div class="col-lg-4 col-xxl-3">
                        <div class="address-details">
                            ...
                            <div class="d-flex flex-column">
                                <p class="mb-0 d-flex align-items-center gap-2">Phone: <a href="tel:34962398486"
                                        class="text-decoration-none link-hover-animation-1">34 96 239 84 86</a></p>
                                <p class="mb-0 d-flex align-items-center gap-2">Email: <a
                                        href="mailto:hello@architronix.com"
                                        class="text-decoration-none link-hover-animation-1">hello@architronix.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-xxl-3">
                        <div class="address-details">
                            ...
                            <div class="d-flex flex-column">
                                <p class="mb-0 d-flex align-items-center gap-2">Phone: <a href="tel:3368856670"
                                        class="text-decoration-none link-hover-animation-1">336 885 6670</a></p>
                                <p class="mb-0 d-flex align-items-center gap-2">Email: <a
                                        href="mailto:hello@architronix.com"
                                        class="text-decoration-none link-hover-animation-1">hello@architronix.com</a>
                                </p>
            ...
            <div
                class="copyright d-flex flex-column gap-2 flex-lg-row justify-content-lg-between align-items-lg-center text-center text-sm-start">
                <p class="mb-0">Made with Love by <a href="https://themeperch.net/"
                        class="text-decoration-none link-hover-animation-1" target="_blank">Themeperch</a></p>
